...
RSpec.describe Redemption, type: :model do
  ...
  describe 'validations' do
    context 'when the user does not have enough points' do
      ...
      # Set discounted_points to nil to force the validation to check the user's points.
      subject { Redemption.new(user: @user, reward: @reward, discounted_points: nil) }
    ...
    context 'when the user has enough points' do
      ...
      # Here we set discounted_points equal to the reward's cost.
